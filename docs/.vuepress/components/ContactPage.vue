      ...
      <div class="contentWrap">
        <div class="gWrap">
            ...
            <div class="miniBlock bg white">
              <div class="descr list">
                <ul>
                  ...
                  <li class="mailIcon">
                    <a href="mailto:info@codefreesoft.com">
                      {{ contact.email }}
                    </a>
                  </li>
                </ul>
          ...
          <div class="gWrap2-3 gWrap-xs-1">
            <div
              class="miniBlock bg white contact_msg_form"
              v-if="!showMessage"
              key="1"
            >
              ...
              <form @submit.prevent="showData">
                ...
                <div class="miniiSet">
                  ...
                  <div class="error" v-if="emailInValid">
                    請輸入正確的郵箱地址
                  </div>
                </div>
                <div class="miniiSet">
                ...
                <div class="iconMessage">
                  <div class="iconMessageWrap">
                    <div class="imgPart float_left">
                      <img src="/kenna-site/contact/popup_tick.png" alt />
                    </div>
                    <div class="textPart">
                    ...
                    <div class="message_content">
                      ...
                      如果就我們的服務有任何疑問，
                      <br />
                      請電(+86) 14715037244 或發送電郵給我們
                      <a href="mailto:mother.technology.limited@gmail.com">
                        mother.technology.limited@gmail.com
                      </a>
                      。
                      <br />
                      <br />
